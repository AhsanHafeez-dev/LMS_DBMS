  ...
  return (
		<Card className="bg-[#152647]">
			<CardHeader className="flex justify-between flex-row items-center">
				<CardTitle className="text-3xl font-extrabold text-mainheading">All Courses</CardTitle>
				...
				<div className="overflow-x-auto">
					<Table className="text-text no-hover-effect">
						<TableHeader className="no-hover-effect">
							<TableRow>
								<TableHead className="text-text text-lg font-bold">Course</TableHead>
								<TableHead className="text-text  text-lg font-bold">Students</TableHead>
								<TableHead className="text-text  text-lg font-bold">Revenue</TableHead>
								<TableHead className="text-text text-lg font-bold">Amount</TableHead>
								<TableHead className="text-text text-lg font-bold">Actions</TableHead>
							</TableRow>
						</TableHeader>

						<TableBody>
							{Array.isArray(instructorCoursesList) && instructorCoursesList.length > 0 ? (
								instructorCoursesList.map((course) => (
									<TableRow key={course.id} className="no-hover-effect">
										...
										<TableCell>${course?.students?.length * course?.pricing || 0}</TableCell>
