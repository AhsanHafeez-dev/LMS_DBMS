...
export default function FooterSection() {
  return (
   <>
   <footer className="bg- border-t border-gray-800 py-14 pb-6 px-10 tracking-wide">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:flex lg:items-center">
           <h1 className="text-gray-400 text-xl font-bold">Learning Mangagement System</h1>
          </div>
        ...
        <p className="text-gray-400 text-sm mt-10">© LMSI. All rights reserved.
        </p>
      </div>
    </footer>
   </>
